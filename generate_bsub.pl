...
perl $0
  ...
  -qc_pl    /home/wangsc/Tools/NGSQCToolkit_v2.3.3/QC/IlluQC.pl
...
#
$qc_pl = "/home/wangsc/Tools/NGSQCToolkit_v2.3.3/QC/IlluQC.pl" unless defined $qc_pl;
my @arr = grep{/R1/} keys %h;
my @params; 
foreach my $f (@arr) {
  my $f2=$f; 
  $f2=~s/R1/R2/; 
...
my $num_param = int ( (scalar @params) / $num_jobs );
...
$aln_pl = "/home/wangsc/pl_scripts/align.pl" unless defined $aln_pl;
$REF="/home/wangsc/scratch_fast/Projects/GBS/wheat/ref_data/wheat_concate/Dgenome/Dgenome.fa" unless $REF;
$REFINDEX="/home/wangsc/scratch_fast/Projects/GBS/wheat/ref_data/wheat_concate/Dgenome/Dgenome.fa" unless $REFINDEX;
...
$call_pl = "/home/wangsc/pl_scripts/unifiedgenotyper.pl" unless $call_pl;
...
foreach my $ind (0 .. $#chrs){
  ...
  print CB "perl $call_pl  -ref $REF -out_prefix RAW -region $chrs[$ind] -bam " . join(" ", @bams), "\n";
  print CB "fi\n\n";
}
